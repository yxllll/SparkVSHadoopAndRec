package TimeSpaceBasedRecommendation
...
object FindSecByRange {
  ...
  def main (args: Array[String]){
    try{
      ...
      val outSecDistAndRan = new PrintWriter(new File("/home/yang/Desktop/tmp/newdis/SecDisAndRanOf-" + jack))
      val outDistDesc = new PrintWriter(new File("/home/yang/Desktop/tmp/newdis/SecDistanceOf-" + jack + "desc"))
      val outMed = new PrintWriter(new File("/home/yang/Desktop/tmp/newdis/SecDistanceOf-" + jack + "andMed"))
      ...
      println("All Second Friend number is: " + secnum)
      ...
      println("SecId MidFriend Distance Range")
      ...
      for(i <- 0 until finaldisandran.length){
        val a = finaldisandran(i).id
        val b = finaldisandran(i).distance
        ...
        val c = finaldisandran(i).range
        val d = finaldisandran(i).medium
